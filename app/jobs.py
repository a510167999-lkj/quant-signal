...
from app.audited_pit_momentum_acceleration_rank import (
    run_audited_pit_momentum_acceleration_rank,
)
...
def main(argv=None) -> int:
    ...
    audited_pit_walk_forward_rank = subparsers.add_parser(
        "research-audited-pit-walk-forward-rank"
    )
    audited_pit_walk_forward_rank.add_argument(
        "--audited-pit-universe-path", required=True
    )
    audited_pit_walk_forward_rank.add_argument(
        "--expected-coverage-audit-sha256", required=True
    ...
    audited_pit_walk_forward_rank.add_argument("--start-date", required=True)
    ...
    audited_pit_momentum_acceleration_rank = subparsers.add_parser(
        "research-audited-pit-momentum-acceleration-rank"
    )
    audited_pit_momentum_acceleration_rank.add_argument(
        "--audited-pit-universe-path", required=True
    )
    audited_pit_momentum_acceleration_rank.add_argument(
        "--expected-coverage-audit-sha256", required=True
    ...
    audited_pit_industry_residual = subparsers.add_parser(
    ...
    audited_pit_ranked_liquidity_rolling = subparsers.add_parser(
        "research-audited-pit-ranked-liquidity-ridge-rolling-oof"
    )
    audited_pit_ranked_liquidity_rolling.add_argument(
        "--audited-pit-universe-path", required=True
    )
    audited_pit_ranked_liquidity_rolling.add_argument(
        "--expected-coverage-audit-sha256", required=True
    ...
    audited_pit_ranked_liquidity_shallow_gbdt_probability_budget.add_argument(
        "--audited-pit-universe-path", required=True
    )
    audited_pit_ranked_liquidity_shallow_gbdt_probability_budget.add_argument(
        "--expected-coverage-audit-sha256", required=True
    ...
    if (
        ...
        report = run_audited_pit_ranked_liquidity_ridge_rolling_oof(
            settings=settings or get_settings(),
            audited_pit_universe_path=args.audited_pit_universe_path,
            expected_coverage_audit_sha256=(
                args.expected_coverage_audit_sha256
