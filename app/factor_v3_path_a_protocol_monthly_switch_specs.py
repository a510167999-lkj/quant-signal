...
WEEKLY_UPDATE_CADENCE = "first_signal_date_of_iso_week"
WEEKLY_STAGE_GOAL_ID = "path-a-protocol-weekly-switch/v1"
SHORT_WINDOW_STAGE_GOAL_ID = "path-a-protocol-short-window-switch/v1"
ESTIMATION_WINDOW_TRADING_DAYS = 126
SHORT_ESTIMATION_WINDOW_TRADING_DAYS = 21
SWITCH_COOLDOWN_TRADING_DAYS = 20
WEEKLY_SWITCH_COOLDOWN_TRADING_DAYS = 5
