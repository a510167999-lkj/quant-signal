...
19. **daily_basic**：733 日旧采集没有 PE/PB。Path A 另采了锁定窗 728 日 `pe/pe_ttm/pb/total_mv/circ_mv`，见 `data/research_cache/jiaoch_daily_basic_value_path_a/`。还没打分。**亏损股不一定不能买**：PE 为空保留，禁止当剔除条件。禁止叠回连跌反弹。
